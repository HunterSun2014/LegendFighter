...
void SampleFpsTextRenderer::Render()
{
	...
	
	{
		...
		//draw move controller
		D2D1_ELLIPSE ellipse = D2D1::Ellipse(
			D2D1::Point2F(120.f, logicalSize.Height - 80.f),
			60.f,
			60.f
		);
		context->DrawEllipse(ellipse, m_whiteBrush.Get());

		//draw fire 0 controller
		...
		//draw fire 1 controller
		ellipse = D2D1::Ellipse(
			D2D1::Point2F(logicalSize.Width - 180, logicalSize.Height - 60),
			50.f,
			50.f
		);
		context->DrawEllipse(ellipse, m_whiteBrush.Get());
	...
	D2D1::Matrix3x2F screenTranslation = D2D1::Matrix3x2F::Translation(
		...
		0.0f	//, logicalSize.Height - m_textMetrics.height
		);
